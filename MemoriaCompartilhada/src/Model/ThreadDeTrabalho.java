 ...
 *
 * <p>Cada instância da classe recebe uma referência para o saldo
 * compartilhado e uma quantidade de vendas a serem realizadas.</p>
 *
 * <p>A classe estende {@link Thread} para permitir a execução
...
public class ThreadDeTrabalho extends Thread{
 /**
   ...
   /**
     ...
     *
     * @param saldoCompartilhado objeto responsável pelo armazenamento
     *                           do saldo compartilhado
     * @param quantidadeVendas quantidade de vendas que serão realizadas
     */
     ...
     *
     * <p>Cada venda adiciona R$ 10,00 ao saldo compartilhado.
